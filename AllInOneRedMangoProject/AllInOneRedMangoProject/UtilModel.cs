...
namespace AllInOneRedMangoProject
{
    class UtilModel
    {
        ...
        public static bool ResultServersMarukhan { get; set; }
        ...
        public static int[,] Game_CruiseAllBetMoney = new int[100, 4];


        public static readonly string[] Royal_GameCodePowerBall = new string[] { "DSCB3", "DSCB5", "EOSP3", "EOSP5", "HSPB3", "HSPB5", "KLAY2", "KLAY5", "BEXB", null, null, null, null, null, null, null, null, null, null, null, null, null, null };
        public static readonly string[] Royal_GameCodeLadder = new string[] { "DSCL3", "DSCL5", "HSPL3", "HSPL5", "KLAYSA2", "KALYSA5", "BEXL_NM" };

        public static readonly string[] Click_GameCodePowerBall = new string[] { "DSCP3", "DSCP5", "EPB3", "EPB", "HSP3", "HSP5", "KLAY2", "KLAY5", null, null, null, "SKPB", "MPB", null, null, null, null, null, null, null, null, null };
        public static readonly string[] Click_GameCodeLadder = new string[] { "CSA3", "CSA5", "HSPSA3", "HSPSA5", "KLAYSA2", "KALYSA5", null, null, null, null, null, null, null, null, null, null, null, null, null, null, null };

        public static readonly string[] Life_GameCodePowerBall = new string[] { "DSCP3", "DSCP5", "EPB3", "EPB", null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null };
        public static readonly string[] Life_GameCodeLadder = new string[] { "CSA3", "CSA5", null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null };
        ...
        private string EPICKGameCode(string gamecode)
        {
            ...
            {
                // 코인파워볼3분
                if (gamecode.Equals("DSCB3"))
                {
                    return "CNBALL3";
                }
                // 코인파워볼5분
                if (gamecode.Equals("DSCB5"))
                {
                    return "CNBALL5";
                }
                // EOS 파워볼 3분
                if (gamecode.Equals("EOSP3"))
                {
                    return "EOSBALL3";
                }
                // EOS 파워볼 5분
                if (gamecode.Equals("EOSP5"))
                {
                    return "EOSBALL5";
                }
                // 하운슬롯 3분
                if (gamecode.Equals("HSPB3"))
                {
                    return "HSBALL3";
                }
                // 하운슬롯 5분
                if (gamecode.Equals("HSPB5"))
                {
                    return "HSBALL5";
                }
                // 코인사다리 3분
                if (gamecode.Equals("DSCL3"))
                {
                    return "CNLADR3";
                }
                // 코인사다리5분
                if (gamecode.Equals("DSCL5"))
                {
                    return "CNLADR5";
                }
                // 하운슬롯사다리 3분
                if (gamecode.Equals("HSPL3"))
                {
                    return "HSLADR3";
                }
                // 하운슬롯사다리5분
                if (gamecode.Equals("HSPL5"))
                {
                    return "HSLADR5";
                }
            }
        ...
        public static string BepickGameCode(string gamecode)
        {
            if (UtilModel.LoginSiteType == UtilModel.LoginSiteType_Click)
            {
                // 코인파워볼3분
        ...
        */
        ...
        {
            int.TryParse(Regex.Replace(textNumber, @"\D", ""), out int outValue);
