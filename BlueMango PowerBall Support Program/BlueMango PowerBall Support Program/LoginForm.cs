        ...
        void btnLogin_Click()
        {
            try
            {
                ...
                if (ControlCheck())
                {
                    ...
                    String returnMessage = loginHandler.BettingSiteUserLoginCheck(UserUrlAddress.Text.ToLower(), UsernameTextBox.Text, HttpUtility.UrlEncode(PasswordTextBox.Text), "1.4.1");
